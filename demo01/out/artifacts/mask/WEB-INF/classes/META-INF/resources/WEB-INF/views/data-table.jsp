...
<head>
    ...
    <!-- owl.carousel CSS
		============================================ -->
    <link rel="stylesheet" href="${ctx }/static/css/owl.carousel.css">
    <link rel="stylesheet" href="${ctx }/static/css/owl.theme.css">
    <link rel="stylesheet" href="${ctx }/static/css/owl.transitions.css">
    <!-- animate CSS
		============================================ -->
    ...
    <!-- meanmenu icon CSS
		============================================ -->
    <link rel="stylesheet" href="${ctx }/static/css/meanmenu.min.css">
    <!-- main CSS
		============================================ -->
    <link rel="stylesheet" href="${ctx }/static/css/main.css">
    <!-- morrisjs CSS
		============================================ -->
    <link rel="stylesheet" href="${ctx }/static/css/morrisjs/morris.css">
    <!-- mCustomScrollbar CSS
		============================================ -->
    <link rel="stylesheet" href="${ctx }/static/css/scrollbar/jquery.mCustomScrollbar.min.css">
    <!-- metisMenu CSS
		============================================ -->
    <link rel="stylesheet" href="${ctx }/static/css/metisMenu/metisMenu.min.css">
    <link rel="stylesheet" href="${ctx }/static/css/metisMenu/metisMenu-vertical.css">
    <!-- calendar CSS
		============================================ -->
    <link rel="stylesheet" href="${ctx }/static/css/calendar/fullcalendar.min.css">
    <link rel="stylesheet" href="${ctx }/static/css/calendar/fullcalendar.print.min.css">
    <!-- x-editor CSS
		============================================ -->
    <link rel="stylesheet" href="${ctx }/static/css/editor/select2.css">
    <link rel="stylesheet" href="${ctx }/static/css/editor/datetimepicker.css">
    <link rel="stylesheet" href="${ctx }/static/css/editor/bootstrap-editable.css">
    <link rel="stylesheet" href="${ctx }/static/css/editor/x-editor-style.css">
    <style type="text/css">
        .editable-clear-x {
            background: url('${ctx }/static/img/clear.png') center center no-repeat;
            display: block;
            width: 13px;
            height: 13px;
            position: absolute;
    ...
    <div class="left-sidebar-pro">
        <nav id="sidebar" class="">
            <div class="sidebar-header">
                <a href="index.html"><img class="main-logo" src="${ctx }/static/img/logo/logo.png" alt="" /></a>
                    ...
                    <ul class="metismenu" id="menu1">
                        ...
                        <li class="active">
                            ...
                            <ul class="submenu-angle" aria-expanded="false">
                                ...
                                <li><a title="Data Table" href="data-table.jsp"><i class="fa fa-th sub-icon-mg" aria-hidden="true"></i> <span class="mini-sub-pro">Data Table</span></a></li>
                            </ul>
                        </li>
                        <li>
...
<%--                                                <th data-field="name" data-editable="true">Product Title</th>--%>
                                                <th data-field="name" data-editable="true">物资名称</th>
                                                <th data-field="company" data-editable="true">规格/型号/参照型号等</th>
                                                <th data-field="price" data-editable="true">其他技术要求</th>
												<th data-field="date" data-editable="true">出口国家</th>
												<th data-field="task" data-editable="true">是否要国标认证</th>
												<th data-field="email" data-editable="true">是否要C认证</th>
												<th data-field="email" data-editable="true">是否要FDA认证</th>
												<th data-field="email" data-editable="true">数量</th>
												<th data-field="email" data-editable="true">单位</th>
												<th data-field="email" data-editable="true">分几个批次出货</th>
												<th data-field="email" data-editable="true">希望单价</th>
												<th data-field="email" data-editable="true">交货方式</th>
												<th data-field="email" data-editable="true">备注</th>
    ...
    <!-- jquery
		============================================ -->
    <script src="${ctx }/static/js/vendor/jquery-1.11.3.min.js"></script>
    <!-- bootstrap JS
		============================================ -->
    <script src="${ctx }/static/js/bootstrap.min.js"></script>
    <!-- wow JS
		============================================ -->
    <script src="${ctx }/static/js/wow.min.js"></script>
    <!-- price-slider JS
		============================================ -->
    <script src="${ctx }/static/js/jquery-price-slider.js"></script>
    <!-- meanmenu JS
		============================================ -->
    <script src="${ctx }/static/js/jquery.meanmenu.js"></script>
    <!-- owl.carousel JS
		============================================ -->
    <script src="${ctx }/static/js/owl.carousel.min.js"></script>
    <!-- sticky JS
		============================================ -->
    <script src="${ctx }/static/js/jquery.sticky.js"></script>
    <!-- scrollUp JS
		============================================ -->
    <script src="${ctx }/static/js/jquery.scrollUp.min.js"></script>
    <!-- mCustomScrollbar JS
		============================================ -->
    <script src="${ctx }/static/js/scrollbar/jquery.mCustomScrollbar.concat.min.js"></script>
    <script src="${ctx }/static/js/scrollbar/mCustomScrollbar-active.js"></script>
    <!-- metisMenu JS
		============================================ -->
    <script src="${ctx }/static/js/metisMenu/metisMenu.min.js"></script>
    <script src="${ctx }/static/js/metisMenu/metisMenu-active.js"></script>

    <!-- data table JS
		============================================ -->
    <script src="${ctx }/static/js/data-table/bootstrap-table.js"></script>
    <script src="${ctx }/static/js/data-table/tableExport.js"></script>
    <script src="${ctx }/static/js/data-table/data-table-active.js"></script>
    <script src="${ctx }/static/js/data-table/bootstrap-table-editable.js"></script>
    <script src="${ctx }/static/js/data-table/bootstrap-editable.js"></script>
    <script src="${ctx }/static/js/data-table/bootstrap-table-resizable.js"></script>
    <script src="${ctx }/static/js/data-table/colResizable-1.5.source.js"></script>
    <script src="${ctx }/static/js/data-table/bootstrap-table-export.js"></script>
    <!--  editable JS
		============================================ -->
    <script src="${ctx }/static/js/editable/jquery.mockjax.js"></script>
    <script src="${ctx }/static/js/editable/mock-active.js"></script>
    <script src="${ctx }/static/js/editable/select2.js"></script>
    <script src="${ctx }/static/js/editable/moment.min.js"></script>
    <script src="${ctx }/static/js/editable/bootstrap-datetimepicker.js"></script>
    <script src="${ctx }/static/js/editable/bootstrap-editable.js"></script>
    <script src="${ctx }/static/js/editable/xediable-active.js"></script>
    <!-- Chart JS
		============================================ -->
    <script src="${ctx }/static/js/chart/jquery.peity.min.js"></script>
    <script src="${ctx }/static/js/peity/peity-active.js"></script>
    <!-- tab JS
		============================================ -->
    <script src="${ctx }/static/js/tab.js"></script>
    <!-- plugins JS
		============================================ -->
